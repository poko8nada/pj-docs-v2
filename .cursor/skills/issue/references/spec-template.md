...
Use this template for the Spec issue body. The Spec is the root of every downstream phase (Design, Forge, Refine). It is persistent: 1 Spec per project or version.
...
- Comments on the Spec record phase lifecycle events (Design / Forge / Refine created or completed) — not day-to-day progress.
- The Spec is the source of truth for product intent. When code drifts from intent, fix Spec or code deliberately — do not silent-drift both.
