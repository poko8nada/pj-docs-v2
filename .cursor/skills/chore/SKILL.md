...
2. Execute `.cursor/skills/scope/SKILL.md` if scope is not open; agree Theme (and label when stable).
3. Before any code or harness file edit, execute `.cursor/skills/rules/SKILL.md` (and a matching `rules/references/*`).
